...
def interactive_menu(
    title: str, choices: List[Dict[str, Any]], allow_filter: bool = True
    ...
    question = inquirer.List(
        "selection", message=title, choices=inquirer_choices, carousel=True
    )
...
def _interactive_menu_with_filter(
    title: str, choices: List[Dict[str, Any]]
) -> Optional[Dict[str, Any]]:
...
def _interactive_menu_without_filter(
    title: str, choices: List[Dict[str, Any]]
) -> Optional[Dict[str, Any]]:
...
def _fallback_text_input(
    message: str, default: str = "", validate=None
) -> Optional[str]:
